...
const Navbar = () => {
  ...
  return (
      <nav className="absolute top-0 left-0 w-full flex items-center justify-end">
        <div className="border border-white/20 border-r-0 border-t-0 p-2 rounded-bl-2xl">
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute -right-2 mt-2 md:w-48 w-44 rounded-lg shadow-lg lg:bg-gray-50/50 bg-gray-50">
